...
describe('ACME Bank', () => {
    ...
    it('should log into a bank account', async () => {
        ...
        // Load the login page.
        await driver.get("https://nitra.test-dealer.com/ng-best/VehicleSearchResults?limit=4&offset=0&sort=featuredPrice%7Cdesc&passive=true&designVariant=staged&forceOrigin=true&ts=1692609925144&showPartners=false#close");

        // Verify the full login page loaded correctly.
        await eyes.check(Target.window().fully().withName("Login ").lazyLoad({
            ...
            waitingTime: 500,   // milliseconds to wait in-between each scroll attempt
                ...
                `document.querySelector("#main > wc-actionbar").style.visibility="unset"`
            ))

            await eyes.check(Target.region())
    });
